...
public class MovieDTO {
    ...
    @Size(min = 2,max = 100,message = "Tên phim có độ dài từ 2 đến 100 ký tự")
    private String name;
    @NotNull(message = "Ngày bắt đầu chiếu phim không được để rỗng")
    private LocalDate startDate;
    @NotBlank(message = "Tên diễn viên không được để rỗng")
    @Size(min = 2,max = 200,message = "Tên diễn viên có độ dài từ 2 đến 200 ký tự")
    private String actor;
    @NotBlank(message = "Tên đạo diễn không được để rỗng")
    @Size(min = 2,max = 100,message = "Tên đạo diễn có độ dài từ 2 đến 100 ký tự")
    private String director;
    @NotBlank(message = "Tên nhà phát hành không được để rỗng")
    @Size(min = 2,max = 100,message = "Tên nhà phát hành có độ dài từ 2 đến 100 ký tự")
