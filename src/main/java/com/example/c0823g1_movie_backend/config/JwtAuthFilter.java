...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private AccountInforAccountDetailService accountInforAccountDetailService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (usename != null && SecurityContextHolder.getContext().getAuthentication() == null){
            UserDetails userDetails = accountInforAccountDetailService.loadUserByUsername(usename);
